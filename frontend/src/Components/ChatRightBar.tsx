...
import { ProfileInfoType } from "../types/api";

const ChatRightBar = ({name, bio, followingCount, followersCount, profile_image, cover_image, username} : ProfileInfoType) => {
  return (
      ...
      <div className=" bg-secondary rounded-xl overflow-hidden">
        ...
        <div className="flex justify-between items-end translate-y-[-2rem]">
          <div className="text-center leading-none ml-3">
            <p className="font-bold text-gray-200">{followersCount && followersCount - 1}</p>
          ...
          <div className="text-center leading-none mr-3">
            <p className="font-bold text-gray-200">{followingCount && followingCount - 1}</p>
